...
import { Text, View, StyleSheet, StatusBar, ScrollView, Image, ImageBackground, TouchableOpacity, FlatList, ToastAndroid } from 'react-native';
...
const timeArray: string[] = ['10:30', '12:30', '14:00', '16:00', '17:00', '18:00', '19:00', '21:00']
...
const generateSeats = () => {
    ...
    for (let i = 0; i < numRow; i++) {
        ...
        for (let j = 0; j < numColumn; j++) {
            ...
            columnArray.push(seatOject)
            seatStart++
        }
        if (i === 3) {
            numColumn += 2
        }
        if (!reachNine && numColumn < 9) {
            numColumn += 2
        } else {
            reachNine = true
            numColumn -= 2
        }
        numArray.push(columnArray)
    ...
    return (
        ...
        >
            ...
            <View style={styles.seatContainer}>
                <View style={styles.containerGap29}>
